...
<main>
  ...
  <div id='2drender'></div>
  {/if}
    <HistoricGraph name="Sense"  data={historicSenseData} maxX={maxGenerations + 1} done={!$running}/> 
    <HistoricGraph name="Population" data={historicPopulationData} maxX={maxGenerations + 1} done={!$running}/>
    <HistoricGraph name="Speed" data={historicSpeedData} maxX={maxGenerations + 1} done={!$running}/>
    <!-- 
  -->
</main>