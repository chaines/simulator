...
const MagnifyingGlassIcon = ({ active = false, onClick }) => (
  <Icon active={active} onClick={onClick} text="Live" color="red">
    <svg
      x="0px"
      y="0px"
      viewBox="0 0 310.42 310.42"
      className="fill-current text-inherit w-8 h-8 mx-auto"
    >
      <g>
        <g>
          <path
